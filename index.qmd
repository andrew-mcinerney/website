...
about:
  ...
  links:
    ...
    - text: "{{< fa brands twitter >}}"
      ...
      href: https://twitter.com/amcinerney_
      
listing: 
- id: publication1
  contents: 
    - "../publication/2023-model-interpretation/index.qmd"
    - "../publication/2023-model-interpretation/index.markdown"
  sort: date desc
  type: grid
  grid-columns: 1
  categories: false
...
- id: publication2
  contents: 
    - "../publication/2022-model-selection/index.qmd"
    - "../publication/2022-model-selection/index.markdown"
  sort: date desc
  type: grid
  grid-columns: 1
  categories: false
...
- id: package
  ...
  max-items: 1
  image-height: "200"
  image-placeholder: ../package/featured.jpg
page-layout: full
...
::: {#package}
:::
[See all &rarr;](../package){.about-links .subtitle}
:::
